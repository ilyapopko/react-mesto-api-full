...
const Header = ({ isLoggedIn, currentUser, onLogout, isUserInfoOpened, setIsUserInfoOpened }) => {
  ...
  return (
    <header className="header">
      {isLoggedIn & isUserInfoOpened ? (<UserInfo email={currentUser.email} onLogout={onLogout} />) : ''}
      <div className="header__container">
        {/*eslint-disable-next-line*/}
        <a href="#" className="header__logo" aria-label="Логотип" target="_blank" />
        {isLoggedIn ? (
          <nav className="header__menu">
            <p className="header__email header__email_hidden">{currentUser.email}</p>
